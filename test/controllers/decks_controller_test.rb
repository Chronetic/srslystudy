...
class DecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post decks_url, params: { deck: { cardcount: @deck.cardcount, category: @deck.category, title: @deck.title, user_id: @deck.user_id } }
    end
  ...
  test "should update deck" do
    patch deck_url(@deck), params: { deck: { cardcount: @deck.cardcount, category: @deck.category, title: @deck.title, user_id: @deck.user_id } }
